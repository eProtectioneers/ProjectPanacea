...
public class PageItem extends JPanel {
	...
	private ImageIcon ic_edit=new ImageIcon(PageItem.class.getResource("/view/PPNCA_Images/icon_edit.png"));
	private ImageIcon ic_save=new ImageIcon(PageItem.class.getResource("/view/PPNCA_Images/icon_accept.png"));
	private ImageIcon ic_reject=new ImageIcon(PageItem.class.getResource("/view/PPNCA_Images/icon_deny.png"));
